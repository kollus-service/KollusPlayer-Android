package kollus.test.media.kollusapi.multidrm.token;

import android.util.Base64;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import kollus.test.media.kollusapi.multidrm.tokenrule.DrmTypes;
...
public class TokenGenerator {
    ...
    public TokenGenerator hash(String accessKey) throws Exception {
        ...
        hash = new String(Base64.encodeToString(md.digest(), Base64.DEFAULT));
    ...
    public String generate() throws JsonProcessingException {
        ...
        return new String(Base64.encodeToString(json.getBytes(), Base64.DEFAULT));
    }
